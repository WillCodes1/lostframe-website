    ...
    <section className="max-w-6xl mx-auto px-4 md:px-8 pt-8">
      ...
      <FadeIn>
        <div className="prose-section mb-12 space-y-5 text-[#4a4a5a] leading-relaxed">
          <p>
            The global macroeconomic landscape is undergoing a structural metamorphosis unparalleled since the industrial revolution.
            Historically, geopolitical and economic hegemony was dictated by access to hydrocarbons. In the twenty-first century, it
            is increasingly defined by <span className="text-[#1a1a2e] font-medium">&ldquo;compute sovereignty&rdquo;</span>: the physical integration of advanced semiconductor
            infrastructure with abundant, reliable, scalable, and cheap baseload electricity <span className="text-xs text-[#7a7a85]">(IEA World Energy Outlook, 2025)</span>.
          </p>
          <p>
            Global electricity demand surged by 4.3% in 2024, nearly double the historical average of 2.7% recorded over the prior decade.
            The rapid expansion of AI data centers is establishing unprecedented, highly concentrated load requirements on regional power grids.
            Nations possessing an absolute energy surplus, unified transmission infrastructure, and a generation mix anchored by nuclear energy
            and large-scale hydroelectricity are uniquely positioned to capture the immense wealth generated by the AI revolution.
            Nations burdened by grid fragmentation and volatile fossil-fuel dependencies face severe electricity crises and technological stagnation <span className="text-xs text-[#7a7a85]">(IEA Electricity Market Report, 2025; EIA Annual Energy Outlook)</span>.
          </p>
          <p>
            The fundamental physics of AI infrastructure dictates a rigid requirement for &ldquo;always-on,&rdquo; high-density electricity.
            Training frontier AI models requires clusters of tens of thousands of GPUs operating continuously for months. A sudden voltage
            drop can instantly ruin a training run, resulting in millions of dollars in lost capital. While solar and wind are the fastest-growing
            new capacity, their intermittency renders them structurally incompatible with the 99.999% uptime requirements of hyperscale
            data centers unless paired with massive, currently cost-prohibitive battery storage <span className="text-xs text-[#7a7a85]">(EPRI; Lazard LCOE Analysis, 2025)</span>.
          </p>
        </div>
      </FadeIn>
