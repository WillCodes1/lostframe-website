...
export default function StudentCTA() {
  ...
  return (
    <section ref={ref} className="max-w-4xl mx-auto px-4 md:px-8 py-20">
      <motion.a
        href="/research/students"
        initial={{ opacity: 0, y: 30 }}
        animate={inView ? { opacity: 1, y: 0 } : {}}
        transition={{ duration: 0.6 }}
        className="group block relative rounded-2xl border border-[#b8860b]/20 hover:border-[#b8860b]/40 overflow-hidden transition-all cursor-pointer shadow-sm hover:shadow-md"
        style={{
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-8">
            ...
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 mb-5">
                ...
                <span className="text-xs font-mono tracking-[0.25em] text-[#b8860b] uppercase">For College Students</span>
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#1a1a2e] mb-4 leading-tight">
                Your Degree Is Being Devalued<br className="hidden sm:block" /> in Real Time.
              </h2>
              <p className="text-[#4a4a5a] leading-relaxed max-w-lg mb-4">
                95% of students are using AI to cheat. Employers know it. The credential is being hollowed out from the inside. 
                42.4% of recent graduates are already underemployed.
              </p>
              <p className="text-sm text-[#7a7a85] leading-relaxed max-w-lg">
                This dedicated student guide breaks down the data, debunks the myths your professors still believe, 
                identifies the skills that actually command a 56% wage premium, and gives you a concrete action plan.
              </p>
            </div>
            ...
            <div className="flex-shrink-0 flex flex-col items-center md:items-end gap-4">
              <div className="flex flex-col items-center text-center md:items-end md:text-right gap-3">
                ...
                <p className="text-xs text-[#7a7a85] max-w-[180px]">of recent graduates are underemployed (Federal Reserve Bank of New York)</p>
              </div>
              <span className="gold-btn inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold rounded-lg mt-2 group-hover:shadow-[0_0_20px_rgba(184,134,11,0.3)]">
